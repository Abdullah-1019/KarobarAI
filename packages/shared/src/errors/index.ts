...
export const CATALOG_ERROR_CODES = {
  ...
  // Feature 13 (AI Store Builder) Task 1.7 additions.
  AI_GENERATION_TIMEOUT: 'AI_GENERATION_TIMEOUT',
  AI_SERVICE_UNAVAILABLE: 'AI_SERVICE_UNAVAILABLE',
  AI_STAGING_NOT_FOUND: 'AI_STAGING_NOT_FOUND',
} as const;
...
// Error codes introduced by the Returns & Refunds feature.
export const RETURN_ERROR_CODES = {
  ...
  RETURN_NOT_OWNED: 'RETURN_NOT_OWNED',
  RETURN_IMAGES_INSUFFICIENT: 'RETURN_IMAGES_INSUFFICIENT',
  RETURN_IMAGE_INVALID_FILE: 'RETURN_IMAGE_INVALID_FILE',
  RETURN_IMAGE_TOO_LARGE: 'RETURN_IMAGE_TOO_LARGE',
  RETURN_IMAGE_NOT_FOUND: 'RETURN_IMAGE_NOT_FOUND',
} as const;
